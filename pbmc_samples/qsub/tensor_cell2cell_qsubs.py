...
for context in contexts:
    ...
    for sample in samples:
        qsub_command = 'qsub -N Tensor_cell2cell-{} '.format(count) \
                       + '-o {}pbmc_samples/qsub/tensor_cell2cell-{}-{}.out '.format(benchmark_folder, sample, suffix) \
                       + '-e {}pbmc_samples/qsub/tensor_cell2cell-{}-{}.err '.format(benchmark_folder, sample, suffix) \
