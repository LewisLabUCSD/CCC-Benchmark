...
# load inputs
data_input_map<-readRDS(paste0(data_path, 'data_input_map_by_context.rds'))
meta_map<-readRDS(paste0(data_path, 'meta_map_by_context.rds'))
...
# Save file
saveRDS(cellchat, file = paste0(output_path, "cellchat_bycontext.rds"))
saveRDS(path.dist, file = paste0(output_path, "pwc_bycontext.rds"))
