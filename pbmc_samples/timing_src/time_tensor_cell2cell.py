...
fig, error = tensor.elbow_rank_selection(upper_rank=25,
                                         ...
                                         filename=output_folder + '/COVID-19-Elbow-{}Samples-{}.png'.format(n_samples, context_name),
                                         random_state=888)
...
fig, axes = c2c.plotting.tensor_factors_plot(interaction_tensor=tensor,
                                             ...
                                             meta_cmaps=cmaps,
                                             fontsize=14,
                                             filename=output_folder + '/COVID-19-TensorFactorization-{}Samples-{}.png'.format(n_samples, context_name)
                                            )

# **Export Loadings**
tensor.export_factor_loadings(output_folder + '/COVID-19-Loadings-{}Samples-{}.xlsx'.format(n_samples, context_name))
